...
const I18N = {
  'zh-CN': {
    ...
    account_qr_login: '扫码登录',
    account_qr_scanning: '请用 B站 App 扫描二维码...',
    account_qr_success: '登录成功！欢迎 {name}',
    account_qr_fail: '扫码登录失败或超时',
    ...
    deploy_gen_configs_desc: '生成 biliTickerBuy 配置文件',
    deploy_deploy_configs: '部署到所有节点',
    deploy_deploy_configs_desc: '同步配置到所有远程机器',
    deploy_cluster_start: '集群开始抢票',
    deploy_cluster_start_desc: '在所有节点上启动抢票引擎',
    deploy_cluster_stop: '集群停止',
    deploy_cluster_stop_desc: '停止所有节点上的抢票引擎',
    deploy_loading: '加载节点信息...',
    deploy_export: '导出全部',
  ...
  'en': {
    ...
    account_qr_login: 'QR Login',
    account_qr_scanning: 'Scan the QR code with Bilibili app...',
    account_qr_success: 'Login successful! Welcome {name}',
    account_qr_fail: 'QR login failed or timed out',
    ...
    deploy_gen_configs_desc: 'Generate biliTickerBuy config files',
    deploy_deploy_configs: 'Deploy to All Nodes',
    deploy_deploy_configs_desc: 'Sync config to all remote machines',
    deploy_cluster_start: 'Start Cluster',
    deploy_cluster_start_desc: 'Start ticket engine on all nodes',
    deploy_cluster_stop: 'Stop Cluster',
    deploy_cluster_stop_desc: 'Stop ticket engine on all nodes',
    deploy_loading: 'Loading node info...',
