<p align="center">
  <img src="web/assets/logo.png" alt="NyaTickerTools" width="128" />
</p>

<h1 align="center">NyaTickerTools</h1>
...
NyaTickerTools 是一个**多工具、多机器协同抢票集群管理系统**。它将 4 个主流 B 站抢票工具整合到统一的配置和管理框架下，支持一键部署到多台机器，通过 Web 管理端集中控制。
...
NyaTickerTools 内置了一个精美的 Web 管理端：
